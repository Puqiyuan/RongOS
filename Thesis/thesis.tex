...
\subsubsection{The Structure of Boot Loader Program}
\label{sec:struct-boot-load}

\begin{center}
  \begin{tikzpicture}
    \node (start) [startstop] {Start};
    \node (in1) [io, below=of start,align=center] {$si=msg\_init$\\$al=[si]$};
    \node (pro1) [process, below=of in1, yshift = -0.5cm] {$si=si+1$};
