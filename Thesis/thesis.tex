...
\section{The Implement of Boot Loader}
\label{sec:imple-boot-loader}

\subsection{Structure of Program}
\label{sec:structure-program}


\begin{center}
  \begin{tikzpicture}[node distance = 2cm]
    \node (start) [startstop]  {Start};
%    \node (in1) [io, below of=start] {si=msg_init al=[si]};
%   \node (pro1) [process, below of = in1] {si=si+1}
