...
written value. The entire inspection process can be shown by ~\ref{fig:mem_tst} and
~\ref{fig:mem_sub}.


\begin{figure}[!ht]
  \centering
  \includegraphics[width=.5\textwidth]{memtest}
  \caption{memory check}
  \label{fig:mem_tst}
\end{figure}

\begin{figure}[!ht]
  \centering
  \includegraphics[width=.5\textwidth]{memtest_sub}
  \caption{subprogram of memory check}
  \label{fig:mem_sub}
\end{figure}
