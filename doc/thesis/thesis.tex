...
The tables ~\ref{tab:BOOTINFO} ~ describes the data structure used by RangOS in tabular form.
...
\begin{table}[!htbp]
  ...
  \begin{tabular}[c]{|c|c|l|}
    ...
    \hline
  \end{tabular}
  \caption{Structure of SEGMENT DESCRIPTOR}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{|c|c|c|}
    ...
    Name & Meaning & Type \\
    \hline
    backlink & previous task link & \multirow{9}{*}{int} \\
    \cline{1-2}
