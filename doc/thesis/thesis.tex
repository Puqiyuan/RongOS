...
\fxerror{need more words.}

\subsection{Platform Setup}
\label{sec:install}

Debian System: there is a small
tutorial\footnote{\url{http://cs2.swfc.edu.cn/~wx672/lecture_notes/linux/install.html}}. \fxerror{need
more words.}
