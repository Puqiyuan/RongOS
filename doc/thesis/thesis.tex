...
\begin{center}
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
    0x13 & \begin{tabular}{@{}c@{}c@{}c@{}c@{}c@{}c@{}c@{}}ah=0x02(read sectors) \\ ah=0x03(write sectors) \\ ah=0x04(verify sectors)
             \\ ah=0x0c(seek to specified track) \\ al=number of sectors processing \\ ch=cylinder
             \verb|&| 0xff  cl=sector number \\ dh=header number dl=driver number \\
             es:bx=buffer address \end{tabular}
