...
\Abstract{操作系统管理着计算机的硬件和软件资源，它是向上层应用软件提供服务（接口）的核心系
  ...
  们的软件工业来说很不利。本文从零开始设计开发一个简单的操作系统，包括boot loader，中断，内
...
\enAbstract{\todo[inline]{need rewrite}Operating system manages the sources of hardware, it lies
  ...
  network communication, security mechanism etc. Operating system development is the
  ...
  Council of China. For a long time, however, the OS kernel development technology grasped
  in the hand of foreigner, it's bad for our software industry cause of limited
  technology. So this article will design and develop a simple operating system, including
...
\todo[inline]{worldwide previous research work}
